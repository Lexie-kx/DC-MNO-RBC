...
def main():
    ...
    if args.max_horizon != 4:
        raise ValueError(
            "M10-2c is deliberately locked "
            "to H4 validation."
        )
    ...
    print(
        "📌 Stage: final pre-candidate control experiment"
    )
    ...
    print(
        "📌 step2-4 trust = predicted P(Path B helps)"
    )
    ...
    print(
        "📌 H4 only; no extrapolation of utility gate to h>4"
    )
    ...
    metadata = {
        ...
        "stage":
            "final_pre_candidate_control_experiment",
    ...
    print(
        ...
        "in closed-loop h3/h4,"
    )

    print(
        "  and preferably improves or at least "
        "matches M6 on h4 global/buoyancy."
    )
