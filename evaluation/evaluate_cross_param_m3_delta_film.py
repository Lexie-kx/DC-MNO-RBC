...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Evaluate M3-Delta-FiLM on cross-parameter test split."
    )
...
def main():
    ...
    print("🚀 [Cross-Param M3-Delta-FiLM Evaluation]")
    ...
    print("👉 FiLM internal params: log10(Ra), log10(Pr), log10(nu), log10(kappa)")
    ...
    print(f"✅ X shape:     {sample_x.shape}，应为 [B, 16, 256, 64]")
    ...
    print("\n================ Cross-Param M3-Delta-FiLM Evaluation ================")
