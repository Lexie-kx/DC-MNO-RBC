...
def parse_args():
    ...
    parser.add_argument(
        "--m6_delta_param_couplingtoken_h4_checkpoint",
        type=str,
        required=True,
        help="Checkpoint for M6-Delta-ParamToken-CouplingToken-H4."
    )
...
def main():
    ...
    m6_delta_param_couplingtoken_h4_ckpt = resolve_path(project_root, args.m6_delta_param_couplingtoken_h4_checkpoint)
    ...
    print(f"📌 M6-Delta-ParamToken-CouplingToken-H4 checkpoint: {m6_delta_param_couplingtoken_h4_ckpt}")
    ...
    m6_delta_param_couplingtoken_h4 = ParamCouplingTokenFNO2d(
        in_channels=16,
        out_channels=4,
        modes1=16,
        modes2=16,
    ...
    m6_delta_param_couplingtoken_h4 = load_model_state(
        m6_delta_param_couplingtoken_h4,
        m6_delta_param_couplingtoken_h4_ckpt,
        device,
    )
    m6_delta_param_couplingtoken_h4.eval()
    ...
    with torch.no_grad():
        for batch_idx, (x0_phys, future_phys, param) in enumerate(loader):
            ...
            m6_couplingtoken_preds = rollout_film(
                model=m6_delta_param_couplingtoken_h4,
                x0_phys=x0_phys,
                param=param,
                normalizer=normalizer,
                max_horizon=max_horizon,
            ...
            for horizon in horizons:
                ...
                update_error_stats(
                    pred_phys=m6_couplingtoken_preds[idx],
                    true_phys=true_h,
                    stats_dict=stats_dict,
                    horizon=horizon,
                    model_name="M6-Delta-ParamToken-CouplingToken-H4",
                )
    ...
    print_model_difference(
        wide_df=wide,
        model_a="M6-Delta-ParamToken-CouplingToken-H4",
        model_b="M5-Delta-ParameterToken-H4",
        title="M6-Delta-ParamToken-CouplingToken-H4 - M5-Delta-ParameterToken-H4"
    )
    ...
    print_model_difference(
        ...
        model_a="M6-Delta-ParamToken-CouplingToken-H4",
        model_b="M5-Delta-H4",
        title="M6-Delta-ParamToken-CouplingToken-H4 - M5-Delta-H4"
    )
    ...
    print_model_difference(
        ...
        title="M6-Delta-ParamToken-CouplingToken-H4 - M5-Delta-FiLM-H4"
    )
