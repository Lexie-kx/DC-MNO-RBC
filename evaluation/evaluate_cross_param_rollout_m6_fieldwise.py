...
def main():
        ...
        for batch_idx, (x0_phys, future_phys, param) in enumerate(loader):
            ...
            for horizon in horizons:
                ...
                update_error_stats(
                    ...
                    stats_dict=stats_dict,
                    horizon=horizon,
                    model_name="M6-FieldWiseEncoder-H4",
                )
    ...
    print_model_difference(
        wide_df=wide,
        model_a="M6-FieldWiseEncoder-H4",
        model_b="M5-Delta-ParameterToken-H4",
        title="M6-FieldWiseEncoder-H4 - M5-Delta-ParameterToken-H4"
    )
    ...
    print_model_difference(
        ...
        model_a="M6-FieldWiseEncoder-H4",
        model_b="M5-Delta-H4",
        title="M6-FieldWiseEncoder-H4 - M5-Delta-H4"
    )
    ...
    print_model_difference(
        ...
        title="M6-FieldWiseEncoder-H4 - M5-Delta-FiLM-H4"
    )
