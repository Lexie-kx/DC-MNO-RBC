...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Cross-parameter rollout evaluation for M0 / M3-Delta / FiLM / M5-H4 / ParamToken / M6-continue / M7-FieldCoupling."
    )
...
def main():
    ...
    print_model_difference(
        wide_df=wide,
        model_a="M6-FieldWiseEncoder-H4-continue",
        model_b="M5-Delta-ParameterToken-H4",
        title="M6-FieldWiseEncoder-H4-continue - M5-Delta-ParameterToken-H4"
    )
    ...
    print_model_difference(
        ...
        model_a="M6-FieldWiseEncoder-H4-continue",
        model_b="M5-Delta-H4",
        title="M6-FieldWiseEncoder-H4-continue - M5-Delta-H4"
    )
    ...
    print_model_difference(
        ...
        title="M6-FieldWiseEncoder-H4-continue - M5-Delta-FiLM-H4"
    )

    print_model_difference(
        wide_df=wide,
        model_a="M7-FieldCoupling-H4",
        model_b="M6-FieldWiseEncoder-H4-continue",
        title="M7-FieldCoupling-H4 - M6-FieldWiseEncoder-H4-continue"
    )
    ...
    print_model_difference(
        ...
        model_a="M7-FieldCoupling-H4",
        model_b="M5-Delta-ParameterToken-H4",
        title="M7-FieldCoupling-H4 - M5-Delta-ParameterToken-H4"
    )
