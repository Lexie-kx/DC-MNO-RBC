...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Cross-parameter rollout evaluation including M7-ParamTokenOnly-H4."
    )
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Checkpoint for M7-FieldCoupling-H4."
    )
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Checkpoint for M7-ParamTokenOnly-H4."
    )
        ...
        for batch_idx, (x0_phys, future_phys, param) in enumerate(loader):
            ...
            for horizon in horizons:
                ...
                update_error_stats(
                    ...
                    stats_dict=stats_dict,
                    horizon=horizon,
                    model_name="M7-FieldCoupling-H4",
                )
                ...
                update_error_stats(
                    ...
                    stats_dict=stats_dict,
                    horizon=horizon,
                    model_name="M7-ParamTokenOnly-H4",
                )
