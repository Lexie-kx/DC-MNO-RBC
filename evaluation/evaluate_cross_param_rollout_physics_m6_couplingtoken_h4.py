...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Evaluate rollout physics diagnostics for M0 / M3-Delta / FiLM / M5-H4 / ParamToken / M6 CouplingToken."
    )
    ...
    parser.add_argument("--m6_delta_param_couplingtoken_h4_checkpoint", type=str, required=True)
...
def main():
    ...
    m6_delta_param_couplingtoken_h4 = load_checkpoint(
    ...
    for batch_idx, batch in enumerate(loader, start=1):
        ...
        with torch.no_grad():
            ...
            seq_m6_delta_param_couplingtoken_h4 = rollout_m3_delta_film(
        ...
        pred_dict = {
            ...
            "M6-Delta-ParamToken-CouplingToken-H4": seq_m6_delta_param_couplingtoken_h4,
        }
