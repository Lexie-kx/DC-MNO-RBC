...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Evaluate rollout physics diagnostics for M0 / M3-Delta / FiLM / M5-H4 / ParamToken / M6 FieldWise-CouplingToken."
    )
    ...
    parser.add_argument("--m6_fieldwise_couplingtoken_h4_checkpoint", type=str, required=True)
...
def main():
    ...
    m6_fieldwise_couplingtoken_h4 = load_checkpoint(
    ...
    for batch_idx, batch in enumerate(loader, start=1):
        ...
        with torch.no_grad():
            ...
            seq_m6_fieldwise_couplingtoken_h4 = rollout_m3_delta(
        ...
        pred_dict = {
            ...
            "M6-FieldWise-CouplingToken-H4-unfreeze": seq_m6_fieldwise_couplingtoken_h4,
        }
