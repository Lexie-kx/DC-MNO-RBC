...
def main():
    ...
    #
    # AUC is an OUTCOME in the robustness experiment.
    # Do NOT force seed123 to reproduce seed42's AUC.
    #
    # The classifier itself is unchanged:
    #   * same Legacy10 / TemporalAlpha20 features
    #   * same TRAIN-only fitting
    #   * same VAL sanity evaluation
    #   * same classifier epochs
    # ====================================================

    for _, row in predictor_sanity.iterrows():
