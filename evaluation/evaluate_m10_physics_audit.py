...
def parse_args():
    ...
    parser.add_argument(
        "--output_dir",
        default="outputs/tables/m10_physics_audit",
    )
...
#
# This avoids contaminating strict PDE residuals with
...
#     + u_n · grad(uy_n)
#
# Same discrete operator is applied to prediction and GT.
# GT therefore provides the discretization / numerical floor.
# ============================================================
...
def finalize_bucket(
    ...
    for prefix in [
        ...
        row[
            f"{prefix}_pred_to_gt_floor_ratio"
        ] = (
            pred_rms
            / max(
                gt_rms,
...
def main():
    ...
    compact_cols = [
        ...
        "r_b_error_rms",
        "r_u_error_rms",
        "r_b_pred_to_gt_floor_ratio",
        "r_u_pred_to_gt_floor_ratio",
    ]

    print()
    print(
        "================ "
        "M10 PHYSICS AUDIT SUMMARY "
        "================"
    )
