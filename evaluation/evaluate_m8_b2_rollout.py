...
def main():
    ...
    m8_a2_checkpoint = resolve_path(
        project_root,
        args.m8_a2_checkpoint,
    )
    m8_b2_checkpoint = resolve_path(
        project_root,
        args.m8_b2_checkpoint,
    )
    ...
    m8_a2 = load_b2_model(
        checkpoint_path=m8_a2_checkpoint,
        device=device,
        expected_adapter_mode=(
            "static_adapter"
        ),
    ...
    m8_b2 = load_b2_model(
        checkpoint_path=m8_b2_checkpoint,
        device=device,
        expected_adapter_mode=(
            "parameter_adapter"
        ),
    ...
    print_and_save_difference(
        wide=wide,
        model_a="M8-B2-ParameterAdapter",
        model_b="M8-A2-StaticAdapter",
        output_path=output_path,
        suffix="m8_b2_minus_m8_a2",
    )
