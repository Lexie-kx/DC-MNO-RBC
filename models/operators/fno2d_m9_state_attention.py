"""
M9-0b-StateDependentFieldAttention-H4 operator.

Position:
    FieldWise Encoder
    -> State-dependent field-axis Attention
    -> Fusion
    -> FNO
...
class M9StateAttentionFNO2d(nn.Module):
    """
    M9-0b: Q/K state-dependent field-axis Attention.
    ...
    The complete spatial Q/K maps contribute to each score,
    but every sample still receives one global [4,4]
    field Attention matrix.
    """
    ...
    def __init__(
        ...
        score_scale_mode: str = "sqrt_token_dim",
        ...
        # The only M9-0b component added to the M6 backbone.
...
StateAttentionFNO2d = M9StateAttentionFNO2d
