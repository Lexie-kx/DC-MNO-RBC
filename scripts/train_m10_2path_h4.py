...
from models.operators.fno2d_m10_2path import (
    M10TwoPathFNO2d,
)
...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "M10-0 formal 2x2 mechanism screening: "
            "Static / Param / State / StateParam, "
            "frozen audited M6 + fixed sparse Path A+B."
        )
    )
...
def main():
    ...
    experiment_labels = {
        "static": (
            "M10-0a Static-2Path-H4"
        ),
        "param": (
            "M10-0b Param-2Path-H4"
        ),
        "state": (
            "M10-0c State-2Path-H4"
        ),
        "stateparam": (
            "M10-0d StateParam-2Path-H4"
        ),
    }
