...
def parse_args():
    ...
    parser.add_argument(
        "--run_name",
        type=str,
        default="m7_fieldcoupling_h4_unseen_pr",
...
def main():
    ...
    print(f"🚀 [M7-FieldCoupling-H4] 启动训练 | 设备: {DEVICE}")
    ...
    wandb.init(
        ...
        name=RUN_NAME,
        config={
            "experiment_type": "m7_fieldcoupling_h4",
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        checkpoint_payload = {
            ...
            'experiment': 'M7-FieldCoupling-H4',
            'base_model': 'M6-FieldWiseEncoder-H4',
