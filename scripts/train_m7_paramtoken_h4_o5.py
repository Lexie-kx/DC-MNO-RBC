...
def parse_args():
    ...
    parser.add_argument(
        "--run_name",
        type=str,
        default="m7_paramtoken_h4_unseen_pr_o5",
    ...
    parser.add_argument(
        ...
        type=int,
        default=42,
        help="Random seed used for model initialization and DataLoader shuffle."
    )
...
def main():
    ...
    print(f"🚀 [M7-ParamTokenOnly-O5-H4] 启动训练 | 设备: {DEVICE}")
